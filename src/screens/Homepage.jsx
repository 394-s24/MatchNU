...
const Homepage = () => {
  ...
  let filteredEvents = !!selectedTags.length
    ? events.filter((event) =>
        selectedTags.every((tag) => event.tags.includes(tag.id))
      )
    : events;
  ...
  if (searchQuery) {
    filteredEvents = filteredEvents.filter((event) => {
      ...
      const eventAtMatch = new Date(event.event_time)
        .toLocaleString()
        .toLowerCase()
        .includes(query);
        ...
        <div className="container-fluid">
          ...
          <Dropdown show={dropdownOpen}>
            ...
            <Dropdown.Menu>
              ...
              <Dropdown.Item onClick={() => setSelectedTags([])}>
                All
              </Dropdown.Item>
                ...
                <Dropdown.Item
                  ...
                  style={{
                    backgroundColor: selectedTags.includes(tag)
                      ? "#007bff"
                      : "transparent", // Example color change
